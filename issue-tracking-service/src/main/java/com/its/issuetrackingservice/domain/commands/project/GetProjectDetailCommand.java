...
@SuperBuilder
@AllArgsConstructor
public class GetProjectDetailCommand extends Command<ProjectDetailResponse> {
    // Inputs
    ...
    @Override
    @Transactional
    public ProjectDetailResponse execute() {
    ...
    @Override
    public Optional<ProjectDetailResponse> getResult() {
        return Optional.ofNullable(projectMapper.toDetailResponse(project));
    }
