package com.its.issuetrackingservice.event.config;

import com.its.issuetrackingservice.event.constant.KafkaConstants;
import com.its.issuetrackingservice.event.consumer.KeycloakEventListener;
import com.its.issuetrackingservice.event.model.KeycloakEvent;
import com.its.issuetrackingservice.event.util.UserEventDeserializer;
