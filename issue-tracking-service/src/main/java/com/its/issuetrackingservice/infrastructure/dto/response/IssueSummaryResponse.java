...
public class IssueSummaryResponse extends AuditableEntityDto {
	...
	@Schema(name = "projectId", description = "The id of the project that this issue is related to", type = "Long", example = "1")
	...
	@Schema(name = "participants", description = "The list of participants", type = "ParticipantsSummaryResponse")
