...
import com.its.keycloakintegrationservice.consumer.KeycloakEventListener;
...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory() {
        ...
        factory.getContainerProperties().setMessageListener(context.getBean(KeycloakEventListener.class));
